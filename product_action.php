...
if(isset($_POST['btn_action']))
{
	...
	{
		$query = "
		INSERT INTO product (category_id, brand_id, product_name, product_description,   product_base_price, product_tax, product_enter_by, product_status, product_date, product_quantity) 
		VALUES (:category_id, :brand_id, :product_name, :product_description,:product_base_price, :product_tax, :product_enter_by, :product_status, :product_date, 0)";
